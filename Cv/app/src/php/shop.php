...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li>
                    <a href="localhost:3000/index.php/" title="Top page">
                ...
                <li><a href="./src/php/product.php?cat=site">websites</a></li>
                <li><a href="./src/php/product.php?cat=mdoels">3D models</a></li>
                <li><a href="./src/php/product.php?action=login">login</a></li>
                <li><a href="/src/php/cart.php">cart</a></li>
            </ul>
        </nav>
    </header>
    <main>
